...
ft_theme <- function(base_size = 12, base_family = "") {
  ...
  theme(
    ...
    axis.text.x =       ggplot2::element_text(margin = ggplot2::margin(t = 0.8 * half_line/2),
                                     vjust = 1),
    axis.text.y =       ggplot2::element_text(margin = ggplot2::margin(l = 0.8 * half_line/2),
                                     hjust = 1),
    axis.ticks =        ggplot2::element_line(colour = "#b0b0b0"),
    axis.ticks.length = ggplot2::unit(half_line/2, "pt"),
    axis.title.x =      ggplot2::element_text(margin = ggplot2::margin(t = 0.8 * half_line, b = 0.8 * half_line/2)),
    ...
    panel.grid.major =     ggplot2::element_line(color = "#b0b0b0"),
    ...
    plot.title = ggplot2::element_text(size = ggplot2::rel(1.2), margin = ggplot2::margin(b = half_line * 1.2)),
